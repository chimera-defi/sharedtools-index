...
* Here are instructions for [getting setup for the first time with the repo](./README.md).
...
* If you find bugs along the way, please log them in the [issues](https://github.com/processing/p5.js/issues).

## 👯 Make tutorials 
* If you are new, this is a great place to start. Try making something yourself, then making a tutorial to teach others to do it too.
